...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BudgetId).HasName("PK__Budgets__E38E79C436C0AEF7");
        ...
        {
            entity.HasKey(e => e.ContractId).HasName("PK__Contract__C90D34098A25BC6D");

            entity.HasIndex(e => e.ContractNumber, "UQ__Contract__C51D43DA40FD5820").IsUnique();
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCDF82790BC");
        ...
        {
            entity.HasKey(e => e.PolicyId).HasName("PK__Discount__2E133944A203FAB1");
        ...
        {
            entity.HasKey(e => e.EquipmentId).HasName("PK__Equipmen__34474599C438CBE5");
        ...
        {
            entity.HasKey(e => e.EventId).HasName("PK__Events__7944C8704EC46CC4");
        ...
        {
            entity.HasKey(e => new { e.EventId, e.EquipmentId }).HasName("PK__EventEqu__FA00BC2928ED0D76");
            ...
            entity.HasOne(d => d.Equipment).WithMany(p => p.EventEquipments)
                ...
                .HasConstraintName("FK__EventEqui__Equip__7E37BEF6");

            entity.HasOne(d => d.Event).WithMany(p => p.EventEquipments)
                .HasForeignKey(d => d.EventId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__EventEqui__Event__7D439ABD");
        });

        modelBuilder.Entity<FieldReport>(entity =>
        {
            entity.HasKey(e => e.ReportId).HasName("PK__FieldRep__D5BD48E562DB9A70");
        ...
        {
            entity.HasKey(e => e.CampaignId).HasName("PK__Marketin__3F5E8D79E794BF2D");
        ...
        {
            entity.HasKey(e => e.ParticipantId).HasName("PK__Particip__7227997EFA6E98BD");

            entity.HasIndex(e => e.Email, "UQ__Particip__A9D105341ACBC3C1").IsUnique();
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3AA1A2BDFF");
        ...
        {
            entity.HasKey(e => e.ResponseId).HasName("PK__SurveyRe__1AAA640C75E65F84");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__SystemAu__5E5499A8FA81691D");
        ...
        {
            entity.HasKey(e => e.TaskId).HasName("PK__Tasks__7C6949D15C6C1B7C");
        ...
        {
            entity.HasKey(e => e.TicketId).HasName("PK__Tickets__712CC6273FB04EBA");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC07994E9F");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E4884D2C61").IsUnique();
