...
public partial class ProjectPrn222Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BudgetId).HasName("PK__Budgets__E38E79C4F2B8B64F");
        ...
        {
            entity.HasKey(e => e.ContractId).HasName("PK__Contract__C90D3409B6A8F8F1");

            entity.HasIndex(e => e.ContractNumber, "UQ__Contract__C51D43DA13F08C14").IsUnique();
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCD11CEA538");
        ...
        {
            entity.HasKey(e => e.PolicyId).HasName("PK__Discount__2E1339446C6E294C");
        ...
        {
            entity.HasKey(e => e.EquipmentId).HasName("PK__Equipmen__34474599B6852967");
        ...
        {
            entity.HasKey(e => e.EventId).HasName("PK__Events__7944C87064C535B8");
        ...
        {
            entity.HasKey(e => new { e.EventId, e.EquipmentId }).HasName("PK__EventEqu__FA00BC29302072FC");
        ...
        {
            entity.HasKey(e => e.ReportId).HasName("PK__FieldRep__D5BD48E5A467EC47");
            ...
            entity.Property(e => e.EstimatePrice)
                ...
                .HasColumnType("decimal(18, 2)"); // ✅ Xóa .HasConversion<double>() và thêm dòng này
        ...
        {
            entity.HasKey(e => e.CampaignId).HasName("PK__Marketin__3F5E8D79A795092C");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E3220ECE184");
        ...
        {
            entity.HasKey(e => e.RentalId).HasName("PK__Outsourc__9700596317EED717");
        ...
        {
            entity.HasKey(e => e.ParticipantId).HasName("PK__Particip__7227997EB76647EA");

            entity.HasIndex(e => e.Email, "UQ__Particip__A9D1053418AB3980").IsUnique();
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__ReturnLo__5E5499A8267BDBCF");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3A810A3AAA");
        ...
        {
            entity.HasKey(e => e.ResponseId).HasName("PK__SurveyRe__1AAA640C3770BFC9");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__SystemAu__5E5499A87D9C90BF");
        ...
        {
            entity.HasKey(e => e.TaskId).HasName("PK__Tasks__7C6949D1F0C9A912");
        ...
        {
            entity.HasKey(e => e.TicketId).HasName("PK__Tickets__712CC6279DDE0316");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC7C8C426C");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E415CEA65C").IsUnique();
        ...
        {
            entity.HasKey(e => e.VendorId).HasName("PK__Vendors__FC8618D356643B41");
